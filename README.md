...
![MLflow Experiments](assets/mlruns.png)

MLflow was used to track experiments and compare model performance, enabling selection of the best-performing LightGBM model.

---

## AWS Deployment

![AWS Lambda](assets/aws1.png)

![API Gateway](assets/aws2.png)

The forecasting API was deployed as a serverless application on AWS Lambda.
...
![Prediction API](assets/get_prediction.png)

Example request and response from the deployed forecasting API.
...
Data drift is continuously monitored using Evidently AI together with statistical validation.
...
Example prediction generated by the deployed retail demand forecasting system.
